...
class ClienteController
{
  ...
  public function crearCliente()
  {
    if ($this->clirut == "" || $this->cliname == "" || $this->clidir == "" || $this->clifono == "" || $this->clifecha == "" || $this->cliemail == "") {
      $_SESSION["errorCli"] = "<i class='fas fa-exclamation-triangle'></i> <b>Error:</b> Por favor rellena el formulario correctamente.";
    ...
    if ($count == 1) {
      $_SESSION["respuestaCli"] = "<i class='fas fa-check-circle'></i> Cliente creado correctamente.";
    } else {
      $_SESSION["errorCli"] = "<i class='fas fa-exclamation-triangle'></i> <b>Error:</b> Base de datos.";
    }
    header("Location: ../views/clientes.php");
  }
}
