...
<head>
    ...
    <title>Iniciar Sesión - Optica Oculus</title>
</head>
            ...
            <div class="col l4 m4 s12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <h5 class="center teal-text text-lighten-2">Iniciar Sesión Vendedores</h5>
                    </div>
                    <div class="card-action">
                        <form action="controllers/LoginController.php" method="POST">
                            ...
                            <p>¿Eres Administrador? <a href="admin.php" class="teal-text text-lighten-2">Inicia Sesión</a></p>
                        </form>
                    </div>
                </div>
            </div>
